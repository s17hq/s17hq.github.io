  ...
  return (
    <footer className="w-full max-w-[700px] px-6 py-4 border-t border-rule flex justify-between flex-wrap gap-3 text-[0.85rem] text-muted max-[580px]:justify-center max-[580px]:text-center sticky bottom-0 bg-bg z-10">
      ...
      <div className="flex gap-3.5">
        <a
          className="hover:text-accent active:text-accent-strong active:scale-[0.96] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent inline-flex items-center transition duration-200"
